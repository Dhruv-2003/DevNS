...
const App = () => {
	...
	const renderNotConnectedContainer = () => (
		<div className="connect-wallet-container">
			<img src="https://media.giphy.com/media/QNFhOolVeCzPQ2Mx85/giphy.gif" alt="Coding monkey gif" />
		...
		return (
			<div className="form-container">
				...
				<input
					type="text"
					value={record}
					placeholder='whats ur dev power '
		...
		<div className="App">
			<div className="container">
				...
				<div className="header-container">
					<header>
						<div className="left">
							<p className="title2"> 🧑‍💻 DEV Name Service</p>
